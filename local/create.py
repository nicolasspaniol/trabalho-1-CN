...
# Baixa grafo direcionado de ruas do OpenStreetMap e salva localmente em formato PKL.
def fetch_and_store_graph(location_query: str, local_filename: str):
    ...
    with open(local_filename, "wb") as f:
        pickle.dump(G, f)
    print("Grafo salvo localmente com sucesso!")
...
if __name__ == "__main__":
    ...
    fetch_and_store_graph(args.location, args.file)
